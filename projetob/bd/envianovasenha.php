<?php
    ...
    $data_senha = date('Y-m-d H:i:s', time()+30*60);
    
    //Verifica se o email informado existe no banco
    $sql = mysqli_query($con, "SELECT * FROM cliente WHERE email = '$email'");
    ...
    if (mysqli_num_rows($sql) == 1){
        ...
        mysqli_query($con, "UPDATE cliente SET chave_senha = '$chave_senha', data_expiracao_senha = '$data_senha' WHERE email = '$email'");
